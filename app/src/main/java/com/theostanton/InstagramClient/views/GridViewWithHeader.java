...
/**
 * Copied from https://github.com/munix/GridViewHeader/blob/master/src/com/munix/gridviewheader/GridView.java
 * for header feature
 */
public class GridViewWithHeader extends android.widget.GridView implements OnScrollListener, android.widget.AdapterView.OnItemClickListener {
    ...
    public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
        if (clickListenerFromActivity != null) {
            clickListenerFromActivity.onItemClick(adapter, view, position - GridViewWithHeader.this.getNumColumnsCompat(), id);
        }
    }
